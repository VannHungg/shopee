...
if (isset($_SESSION['level'])) {
    if ($_SESSION['level'] != 2) {
        $_SESSION['status'] = "fail";
        $_SESSION['message'] = "Bạn cần đăng nhập vào tài khoản khách hàng";
        header('Location: signin.php');
        return 0;
    }
}

// require('check_customer_login.php');
        ...
        <header class="header">
            <div class="grid">
                ...
                <div class="header-with-search">
                    ...
                    $sql_num_product = "SELECT count(*) FROM products WHERE name LIKE '%$search%'";
                    $arr_num_product = mysqli_query($connect, $sql_num_product);
                    $results_num_product = mysqli_fetch_array($arr_num_product);
                    $num_product = $results_num_product['count(*)'];

                    $num_product_per_page = 10;
                    $num_page = ceil($num_product / $num_product_per_page);

                    $page = isset($_GET['page']) ? $_GET['page'] : 1;
                    $page_skip = ($num_product_per_page) * ($page - 1);

                    $sql = "SELECT *FROM products WHERE name LIKE '%$search%'
                            LIMIT $num_product_per_page OFFSET $page_skip";
                    $results = mysqli_query($connect, $sql);
                    ?>
                    ...
                    <form action="history_search.php" method="get" class="header__search">
                        ...
                        <div class="header__search-selection">
                            ...
                            <i class="header__search-selection-icon fa-solid fa-angle-down"></i>

                            <!--option-->
                            <ul class="header__search-list">
                                <!--item-->
                                <li class="header__search-item header__search-item--has-icon">
                                            ...
                                            <li class="header__cart-item">
                                                ...
                                                <div class="header__cart-item-info">
                                                    <div class="header__cart-item-head">
                                                        ...
                                                        <div>
                                                            <span class="header__cart-item-price"><?= number_format($each['price']) ?>đ</span>
